...
import {swReadyMessage, swUpdateMessage} from 'config.js';
...
if ('serviceWorker' in navigator) {
	...
	window.addEventListener('load', async () => {
		...
		const {message, swToast} = await import(/* webpackChunkName: 'utils' */ '../utils.js');
		const {Workbox} 				 = await import(/* webpackChunkName: 'workbox-window' */ 'workbox-window');

		// This file is autogenerated by workbox-webpack-plugin.
